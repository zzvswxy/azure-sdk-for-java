...
public class ContainerRegistryBlobClient {
    ...
    public Response<UploadManifestResult> uploadManifestWithResponse(BinaryData data, Context context) {
        return this.asyncClient.uploadManifestWithResponse(data.toFluxByteBuffer(), context).block();
    }
    ...
    public Response<UploadBlobResult> uploadBlobWithResponse(BinaryData data, Context context) {
        return this.asyncClient.uploadBlobWithResponse(data.toFluxByteBuffer(), context).block();
    }
    ...
    public Void deleteBlob(String digest) {
        return this.deleteBlobWithResponse(digest, Context.NONE).getValue();
    }
    ...
    public Void deleteManifest(String digest) {
        return this.deleteManifestWithResponse(digest, Context.NONE).getValue();
    }
